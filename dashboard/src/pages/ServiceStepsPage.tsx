...
import {
  ArrowDown, ArrowUp, CheckCircle2, Loader2, Plus, Save, Trash2,
} from 'lucide-react';
                ...
                <div className="pt-1">
                  ...
                  <div className="divide-y divide-border">
                    {draft.map((step, index) => (
                      <div key={step.key} className="flex items-start gap-2.5 py-2.5">
                        <span className="text-[11px] font-semibold text-muted-foreground/70 shrink-0 pt-2.5 w-4 text-right">
                          {index + 1}
                        </span>
                        ...
                        <div className="flex items-center gap-0.5 shrink-0 pt-1">
                          <button
                            ...
                            disabled={index === 0}
                            className="h-6 w-6 flex items-center justify-center rounded text-muted-foreground hover:bg-muted hover:text-foreground disabled:opacity-25 disabled:pointer-events-none"
                            title="Move up"
                          >
