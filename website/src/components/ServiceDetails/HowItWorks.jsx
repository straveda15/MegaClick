...
const HowItWorks = ({ service }) => {
  ...
  return (
    <section className="w-full bg-blue-100/60 font-['Inter',sans-serif] py-10 sm:py-12 lg:py-16">
      {/* GOOGLE FONTS */}
      <style>{`
      ...
      >
        ...
        >
          {/* =========================================
              HEADING + DESCRIPTION (Consistent Layout)
          ========================================== */}
          <div className="mb-8 sm:mb-10 lg:mb-12 flex items-start justify-between">
            ...
            <div className="flex items-center gap-2 lg:hidden flex-shrink-0 mt-2">
              <button
                ...
                className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center text-gray-600 transition-all duration-200 disabled:opacity-30 disabled:cursor-not-allowed active:scale-95 bg-white shadow-xs"
              ...
              {service.process.map((_, i) => (
                <span
                  ...
                  className={`h-2 rounded-full transition-all duration-300 ${
                    i === currentStep ? "bg-[#0B4EA2] w-6" : "bg-gray-200 w-2"
                  }`}
                />
              ))}
            </div>
          ...
          {/* =========================================
              DESKTOP TIMELINE (Horizontal Connected Steps)
          ========================================== */}
              ...
              {service.process.map((step, index) => (
                <div key={index} className="relative flex-1 min-w-0 text-left">
                  ...
                  <div className="pr-3">
                    ...
                    <p
                      style={{ fontFamily: "'Inter', sans-serif" }}
                      className="hiw-step-desc text-xs sm:text-sm text-gray-600 leading-relaxed font-normal"
                    >
                      {step.description}
                    </p>
                  </div>
