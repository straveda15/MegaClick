  ...
  return (
    <section className="relative overflow-hidden bg-white py-6 sm:py-10 lg:py-12">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-8 lg:px-16 xl:px-20">
        {/* MAIN GRID ALIGNED TO TOP */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-14 items-start">
          
          {/* PHOTOS (LEFT SIDE) */}
          <div className="relative grid grid-cols-2 gap-3 sm:gap-4 md:gap-5 w-full">
            {/* IMAGE 1 */}
            <div
          ...
          {/* RIGHT CONTENT SHIFTED HIGHER */}
          <div className="w-full pt-1 lg:pt-2">
            {/* HEADING (Hedvig Letters Serif - Lighter Weight: 400) */}
            <h2
            ...
            {/* DESCRIPTION / SUBHEADING (Inter Font) */}
            <p className="mt-4 sm:mt-5 text-slate-600 text-sm sm:text-base leading-relaxed max-w-xl font-normal">
            ...
            {/* LEARN MORE BUTTON AT BOTTOM OF PARAGRAPH */}
            <div className="mt-5 sm:mt-7 flex justify-start">
              <button
